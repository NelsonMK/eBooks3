...
class Twilio {
    ...
    {
        $CI =& get_instance();
        $CI->config->load('twilio', true);
        $twilio_config = $CI->config->item('twilio');
        $sid = $twilio_config['twilio_sid'];// $CI->config->item('twilio_sid');
        $token = $twilio_config['twilio_token'];// $CI->config->item('twilio_token');
